...
class DownloadModelActivity : ComponentActivity() {
    ...
    private fun DownloadModelScreen(
        ...
        Column(modifier = modifier) {
            ...
            Text(
                "Tap the button below to automatically download the Gemma 3n-E2B GGUF model from Hugging Face. The model will be saved to your Downloads folder.",
            ...
            OutlinedButton(
                ...
                Icon(FeatherIcons.Download, contentDescription = "Download Gemma Model")
                AppSpacer4W()
                Text("Download Gemma 3n-E2B Model")
            }
            Spacer(modifier = Modifier.height(16.dp))
            Text(
                text = "OR",
